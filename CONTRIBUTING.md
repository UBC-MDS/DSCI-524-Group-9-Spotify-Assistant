...
1. Download a copy of `spotify_assistant` locally.
2. Install `spotify_assistant` using `poetry`:
...
Please note that the `spotify_assistant` project is released with a
